...
Pupil Localization is an instance of the problem of object Localization. The objective is to localize the pupil in a image of an eye. In normal cases, pupil localization is not achieved with deep neural networks. There already exist more computationally efficient methods for this task, such as \parencite{markuvs2014eye}. On the other hand deep neural networks for semantic segmentation are capable of predicting high quality segmentation maps on diverse complicated data sets \parencite{ChenPK0Y16semantic} and should therefore perform extraordinary well on the relatively simple task of pupil localization.
...
TODO: Måste motivera kvalitativt att regressorn i princip är perfekt (Kan även motiveras av subpixelpresicionen på syntetiska datan).
...
A propiretary data set was used to further evaluate the methods. The data set consits of 9605 different manually annotated recordings of human subjects looking at a screen. Each recording consists of a set of ROI images of the eye region of the subjects. 
