...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.7\textwidth]{graphicalModel.pdf}
...
However, they do not need to decrease a divergence at each step \textcite{fedus2017many}.
...
\begin{algorithm}
    ...
    \begin{algorithmic}[1]
        ...
        \STATE TODO: Write the equations explicitly with reconstruction loss.
        \ENDFOR
    \end{algorithmic}
\end{algorithm}
